...
export const PromptInputSubmit = ({
  ...
  let Icon = <ArrowUpIcon weight="bold" className="size-4" />;

  if (status === "submitted") {
    Icon = <CircleNotchIcon weight="bold" className="size-4 animate-spin" />;
  } else if (status === "streaming") {
    Icon = <SquareIcon weight="bold" className="size-4" />;
