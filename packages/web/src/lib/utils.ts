 ...
 * @returns Formatted string like "moments ago", "5 minutes ago", "3 hours ago", "yesterday", "this week", or "Jun 15, 9:34"
 */
...
export function formatRelativeTimeCapitalized(timestamp: number): string {
